...
const Nav=(prop)=>{
    ...
    return(
        <div className={N.nav}>
                ...
                <div className={N.navIcon} onClick={()=>{window.location='/'}}>
                ...
                <div className={N.navIcon} onClick={()=>{window.location='/dashboard'}}>
                ...
                <div className={N.navIcon} onClick={()=>{window.location='/wishlist'}}>
